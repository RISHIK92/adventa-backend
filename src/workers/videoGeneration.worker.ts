...
📚 This educational video was automatically generated to explain complex concepts through visual animations.

🎯 Topic: ${questionDetails.subject || "Mathematics"}
...
console.log("🚀 Video generation worker with YouTube upload started!");
